...
typedef enum {
	RTCommandStatus_NO_RESULT = 0,
	RTCommandStatus_OK,
	RTCommandStatus_CLASS_NOT_FOUND_EXCEPTION,
	RTCommandStatus_ILLEGAL_ACCESS_EXCEPTION,
	RTCommandStatus_INSTANTIATION_EXCEPTION,
	RTCommandStatus_MALFORMED_URL_EXCEPTION,
	RTCommandStatus_IO_EXCEPTION,
	RTCommandStatus_INVALID_ACTION,
	RTCommandStatus_JSON_EXCEPTION,
	RTCommandStatus_ERROR
} CDVCommandStatus;
	
@interface RTPluginResult : NSObject {
