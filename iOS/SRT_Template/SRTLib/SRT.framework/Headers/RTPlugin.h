...
#define RTPluginHandleOpenURLNotification	@"RTPluginHandleOpenURLNotification"
...
@interface RTPlugin : NSObject {
}

@property (nonatomic, retain) UIWebView* webView;
@property (nonatomic, retain) NSDictionary* settings;
@property (nonatomic, retain) UIViewController* viewController;
@property (nonatomic, retain) id<RTCommandDelegate> commandDelegate;
