...
typedef NSUInteger RTCaptureError;
...
@interface RTCapture : RTPlugin<UIImagePickerControllerDelegate, UINavigationControllerDelegate> 
{
 ...
 */
@interface RTAudioRecorderViewController : UIViewController <AVAudioRecorderDelegate>
{
    RTCaptureError errorCode;
    NSString* callbackId;
    NSNumber* duration;
    RTCapture* captureCommand;
...
@property (nonatomic) RTCaptureError errorCode;
@property (nonatomic, copy) NSString* callbackId;
@property (nonatomic, copy) NSNumber* duration;
@property (nonatomic, retain) RTCapture* captureCommand;
...
- (id) initWithCommand: (RTPlugin*) theCommand duration: (NSNumber*) theDuration callbackId: (NSString*) theCallbackId filepath:(NSString*) filepath;
