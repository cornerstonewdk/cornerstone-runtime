...
@interface RTContacts : RTPlugin <ABNewPersonViewControllerDelegate, 
...
@interface RTContactsPicker : ABPeoplePickerNavigationController
{
	BOOL allowsEditing;
	NSString* callbackId;
...
@interface RTNewContactsController : ABNewPersonViewController
{
	NSString* callbackId;
}
@property (copy) NSString* callbackId;
 ...
 */ 
@interface RTDisplayContactViewController : ABPersonViewController
{
    
}
@property (nonatomic,retain) RTPlugin* contactsPlugin;
